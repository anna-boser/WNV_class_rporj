...
## 1. Request Parameters  
    ...
    Name: Landsat_July_2019  

    Date Completed:** 2020-12-10T04:15:06.815892  

    Id: 1d8cbadf-e8a1-437d-b38d-5e37413ef247  
...
- Comma-separated values file with data extracted for a specific product
  - Landsat-July-2019-CU-LC08-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - Landsat-July-2019-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - Landsat-July-2019-request.json
- xml file
  - Landsat-July-2019-CU-LC08-001-metadata.xml  
