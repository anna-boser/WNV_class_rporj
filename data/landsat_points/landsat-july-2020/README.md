...
## 1. Request Parameters  
    ...
    Name: Landsat_July_2020  

    Date Completed:** 2020-12-10T04:14:35.412370  

    Id: 255d464f-1cd2-48fa-911b-4c41f711660a  
...
- Comma-separated values file with data extracted for a specific product
  - Landsat-July-2020-CU-LC08-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - Landsat-July-2020-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - Landsat-July-2020-request.json
- xml file
  - Landsat-July-2020-CU-LC08-001-metadata.xml  
