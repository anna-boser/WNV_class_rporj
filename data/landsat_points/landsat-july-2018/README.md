...
## 1. Request Parameters  
    ...
    Name: Landsat_July_2018  

    Date Completed:** 2020-12-10T04:15:38.873006  

    Id: 94cfe6c1-2a76-4941-910e-2e89e5b51dea  
...
- Comma-separated values file with data extracted for a specific product
  - Landsat-July-2018-CU-LC08-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - Landsat-July-2018-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - Landsat-July-2018-request.json
- xml file
  - Landsat-July-2018-CU-LC08-001-metadata.xml  
